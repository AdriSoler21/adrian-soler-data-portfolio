...
This project contains a set of business analytics scripts focused on pricing strategy, marketplace performance, conversion rate analysis and price elasticity.
...
In ecommerce and marketplace environments, the same product can behave differently depending on the sales channel.

Price differences, traffic quality, conversion rates, stock availability and product visibility can all influence commercial performance.
...
- Commercial prioritization by product
...
- Conversion rate calculation by channel
...
Builds a price elasticity and optimization workflow based on product traffic, sales, conversion rate and purchase cost.
